    ...
    <div id="app">
        ...
        <div class="container">
            <div class="card">
                ...
                @click="showNewCourseModal()">Actualizar</button>
            </div>
        </div>
        <modal name="newcourse-added" height="auto" :adaptive="true">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title">Curso editado</h3>
                </div>
                <div class="modal-body">
                    <p>
                        El curso {{Course.Course_name}} se ha editado correctamente
                    </p>
                </div>
        ...
        <modal name="confirm-newcourse" height="auto" :adaptive="true">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title">¿Deseas editar este curso?</h3>    
                </div>
                <div class="modal-body">
                    <p>
                        El curso se editara y los cambios se veran reflejados en el Syllabus del programa de inmediato
                    </p>
                </div>
                <div class="modal-footer">
                    <button class="btn btn-default"
