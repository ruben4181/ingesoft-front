<template>
    <div id="app">
        ...
        <modal name="confirm-newprogram" height="auto" :adaptive="true">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title">¿Deseas agregar este programa al sistema?</h3>
                </div>
        ...
        <modal name="program-added" height="auto" :adaptive="true">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title">Agregado con exito</h3>
                </div>
                <div class="modal-body">
                    <p>
                        El nuevo programa se ha añadido de forma exitosa al sistema</p>
                </div>
                <div class="modal-footer">
                    <router-link :to="{name:'Home'}">
                        <button class="btn btn-default">
        ...
        sendNewProgram : function () {
            ...
            axios.get("http://localhost:8080/getUser/"+this.username).then(response=>{
                ...
                if (this.program.ID_user>0){
                    axios({
                        method: 'post',
                        url: 'http://localhost:8080/newProgram',
